...
class AcompanhamentoOperacaoPage extends StatefulWidget {
  final VoidCallback onVoltar;

  const AcompanhamentoOperacaoPage({
    super.key,
    required this.onVoltar,
  });

  @override
  State<AcompanhamentoOperacaoPage> createState() => _AcompanhamentoOperacaoPageState();
}

class _AcompanhamentoOperacaoPageState extends State<AcompanhamentoOperacaoPage> {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          _mostrarDetalhes 
              ? 'Detalhes da Ordem' 
              : 'Em operação - ${_terminais.firstWhere((f) => f['id'].toString() == _terminalFiltroId, orElse: () => {'nome': ''})['nome'] ?? ''}',
