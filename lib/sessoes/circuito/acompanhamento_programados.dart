...
class AcompanhamentoProgramadosPage extends StatefulWidget {
  final VoidCallback onVoltar;

  const AcompanhamentoProgramadosPage({
    super.key,
    required this.onVoltar,
  });

  @override
  State<AcompanhamentoProgramadosPage> createState() => _AcompanhamentoProgramadosPageState();
}

class _AcompanhamentoProgramadosPageState extends State<AcompanhamentoProgramadosPage> {
          ...
          child: InkWell(
            ...
            child: Container(
              ...
              child: Row(
                ...
                children: [
                   // Lado Esquerdo: Carga ou Descarga
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          _mostrarDetalhes 
              ? 'Detalhes da Ordem' 
              : 'Programados - ${_terminais.firstWhere((f) => f['id'].toString() == _terminalFiltroId, orElse: () => {'nome': ''})['nome'] ?? ''}',
